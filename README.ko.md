...
- **블라인드 테스트** (어떤 도구인지 모르는 에이전트가 질문 20개를 만들고 채점): wikimap **14/20** vs graphify **11/20**, 유용성 투표 **16:3:1** 승.

테스트 126건(stdlib만), macOS·Linux·Windows / Python 3.8~3.13에서 CI가 돕니다.
